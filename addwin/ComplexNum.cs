...
namespace addwin
{
    public class Complex
    {
        ...
        public Complex Divi(Complex comp)
        {
            double x = (real*comp.real+imaginary*comp.imaginary)/(comp.real*comp.real+comp.imaginary*comp.imaginary);
            double y = (imaginary*comp.real - real*comp.imaginary)/(comp.real*comp.real + comp.imaginary*comp.imaginary);
            return new Complex(x, y);
        }
        public void Copy(Complex[] Sdata1, Complex[] Sdata2,int len)
        {
            for(int i=0;i<len; i++)
            {
                Sdata2[i] = new Complex(0, 0);
                Sdata2[i] = Sdata1[i];
